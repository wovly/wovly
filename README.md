...
<p align="center">
  <img src="assets/insights.png" alt="Insights Dashboard" width="800">
</p>
...
- **Draft Actions** – Generate action drafts directly from insights before executing them

**How it works:** Every hour, Wovly analyzes new messages using AI to extract facts and detect patterns. Insights are generated by cross-referencing messages with your profile, goals, and calendar. Use the "Draft Action" button to prepare responses or actions before they're sent.
...
**Smart Web Scraping:** Extract messages from sites like Brightwheel, MyChart, tax portals, or custom internal tools using:
- **Recording Wizard** – Record your login flow once, replay it automatically on schedule
- **Automatic 2FA** – Retrieves verification codes from iMessage (SMS) or Gmail (Email) automatically
- **OAuth/SSO Support** – Works with Google, Microsoft, and other OAuth providers
- **Session Management** – Keeps you logged in across scraping runs
